/*
* NEW BrowserCompAPI version 1.0.2.22
...
function IsToolbarReady(callback) {
return BcApiObj.IsToolbarReady(callback);
};
...
this.IsToolbarReady = function (callback) {
if (communicate.isSupportedFunction("isToolbarReady"))
communicate.isToolbarReady(callback);
else {
if (callback) {
callback(UNSUPPORTED);
}
...
"platform": { "isToolbarVisible": "", "getToolbarBornDate": "", "onChangeViewState": { "addListener": "eventHandler"}, "getToolbarVersion":"" ,"executeExternalProgram": "registeredName, parameters", "getAppsList": "", "isToolbarReady": "", "onToolbarReady": { "addListener": "eventHandler"}, "getInfo": "", "isAppInstalled": "appId", "refresh": "forceRefresh", "refreshApp": "appId", "setSkin": "settings", "search": { "getTerm": "", "onExecuted": { "addListener": "eventHandler" }, "onTextChanged": { "addListener": "eventHandler"} }, "getScreenHeight": "", "getScreenWidth": "", "openApp": "guid" },
...
this.isToolbarReady = function (callback){
var callbackFunction = createCBFunction(callback);
conduit.platform.isToolbarReady(callbackFunction);
};
this.createNestedContext = function (frameId, callback){
